<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/User_Doctor/Doctor_MasterPage.Master" AutoEventWireup="true" CodeFile="Appointments.aspx.cs" Inherits="DoctorsAppointmentManager.Pages.User_Doctor.Appointments" %>
			...
			<div id="div_AppointmentsList" class="div_AppointmentsList">
				...
				<div id="div_cases" class="div_cases">
					<div id="div_case" class="div_case">
						<div class="col">
							...
							<div class="row">
								<div class="col PName">
									<a id="A_PHistoryLink" tabindex="-1" updated="true" pagelink="<%=ResolveClientUrl("~/Doctor/PatientHistory/")%>" href="#" target="_blank">
				...
				<div id="div_nocases" class="div_nocases">
					<div id="div_nocase" class="div_nocase">
						<span class="NoCase">No New Appointments are scheduled</span>
					</div>
				</div>
			</div>
		</div>
