<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/User_Receptionist/Receptionist_MasterPage.Master" AutoEventWireup="true" CodeFile="PatientHistory_List.aspx.cs" Inherits="DoctorsAppointmentManager.Pages.User_Receptionist.PatientHistory_List" %>
				...
				<div id="div_cases" class="div_cases">
					<div id="div_case" class="div_case">
						<div class="col">
							...
							<div class="row">
								<div class="col PName">
									<a id="A_PHistoryLink" tabindex="-1" pagelink="/Receptionist/PatientHistory/" href="#" target="_blank">
